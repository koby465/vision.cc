...
local ThemeManager = {} do
    ...
    ThemeManager.BuiltInThemes = {
        ["Default"] = { 1, httpService:JSONDecode([[{"FontColor":"ffffff","MainColor":"191919","AccentColor":[0.784,0.510,0.784],"BackgroundColor":"121214","OutlineColor":"2d2d30","FontFace":"Gotham"}]]) },
